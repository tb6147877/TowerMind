...
Other TowerMind game settings are consistent with the other documentation of this project ([guide.md](../guide.md)) and can be adjusted according to your needs.
